/* Shared partials v3: brand mark, header, mobile drawer, footer, dashboard mock, headshot slot */
      ...
      <div className="container">
        <div className="site-footer__grid">
          ...
          <div>
            <h4>Elements</h4>
            <ul>
              <li><a href="elements.html#constructor-studio">Constructor Studio</a></li>
              <li><a href="elements.html#constructor-insight">Constructor Insight</a></li>
              <li><a href="elements.html#constructor-ware">Constructor Gears</a></li>
            </ul>
          </div>
          <div>
            <h4>Resources</h4>
